...
# 
# The goal of this section of the course is to create a Python script that will accept the value of your portfolio and tell you how many shares of each S&P 500 constituent you should purchase to get an market-cap-weighted version of the index fund.
# 
# ## Library Imports
# 
...
#number_of_apple_shares = position_size/apple_price
...
writer = pd.ExcelWriter('recommended trades (marketcap).xlsx', engine= 'xlsxwriter') # pylint: disable=abstract-class-instantiated 
